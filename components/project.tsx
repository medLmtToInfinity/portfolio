...
const Project: React.FC<ProjectItem> = ( { title, description, link, imgSrc } ) => {
  return (
    <a href={link} target='_blank' className='mb-12 hover:opacity-0 flex items-center group relative transition-all lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
